...
;(function (factory) {
    ...
    let addMetaDataAfterRender = function (elements, data) {
    ...
    let prepareTemplateOptions = function (valueAccessor, dataName) {
        let result = {},
    ...
    let updateIndexFromDestroyedItems = function (index, items) {
        let unwrapped = unwrap(items);
    ...
    let stripTemplateWhitespace = function (element, name) {
        let templateSource,
            templateElement;
    ...
    ko.bindingHandlers.sortable = {
        init: function (element, valueAccessor, allBindingsAccessor, data, context) {
            ...
            if (sortable.connectClass && (ko.isObservable(sortable.allowDrop) || typeof sortable.allowDrop == 'function')) {
                ko.computed({
                    read: function () {
                        let value = unwrap(sortable.allowDrop),
            ...
            let createTimeout = setTimeout(function () {
                let dragItem;
                let originalReceive = sortable.options.receive;
                                ...
                                if (targetIndex >= 0) {
                                    if (sourceParent) {
                                        if (sourceParent !== targetParent) {
                                            ...
                                            let underlyingList = unwrap(sourceParent);
    ...
    ko.bindingHandlers.draggable = {
        ...
        update: function (element, valueAccessor, allBindingsAccessor, data, context) {
            let templateOptions = prepareTemplateOptions(valueAccessor, 'data');
