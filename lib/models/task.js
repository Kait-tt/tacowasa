...
class Task {
    ...
    static updateOrder(projectId, taskId, beforeTaskId) {
        return co(function* () {
            ...
            const beforeTask = beforeTaskId ? (yield Task.findOne({where: {id: beforeTaskId, projectId}})) : null;
            ...
            return {
                ...
                beforeTask: beforeTaskId ? (yield Task.findOne({where: {id: beforeTaskId, projectId}})) : null,
                updated: true
            };
        });
    }
